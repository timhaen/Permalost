(function () {
  ...
  function drawBarChart(data, categoryThresholds) {
    ...
    barChartSvg
      ...
      .attr("x2", 36)
      .attr("y2", 25) // Align with the bottom of the bars
      .attr("stroke", "#A9A9A9")
      .attr("stroke-width", 1);

    // Add grid lines and labels for 100, 200, and 300
    [0, 250, 500].forEach((value) => {
      barChartSvg
        .append("line")
        .attr("class", "grid")
        .attr("x1", 36)
      ...
      barChartSvg
        ...
        .attr("x", width / 10 - 2)
        .attr("y", height - 18 - value * unitHeight)
    ...
    barChartSvg
      ...
      .attr("x", (d, i) => (width / 5) * 0.77 + i * barWidth + 12)
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  creditsButton.addEventListener("click", function (event) {
    ...
    backgroundBlur.style.display =
      backgroundBlur.style.display === "none" ? "block" : "none";
  });
